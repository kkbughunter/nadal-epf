  ...
  return (
    <>
        ...
        <div className="mx-auto grid w-[96vw] max-w-[1120px] gap-8 lg:grid-cols-2 lg:items-center">
          <div>
            <h1 className="text-5xl font-bold leading-tight md:text-6xl">
              PF issues solved.
              <span className="block text-blue-600">Or you get your money back.</span>
            </h1>
            <p className="mt-4 text-slate-600">Get your PF withdrawn smoothly, and enjoy complete peace of mind.</p>
            <p className="mt-5 inline-block rounded-full bg-emerald-100 px-3 py-1 text-xs text-emerald-700">20+ consultations booked in the last hour</p>
          </div>
          <article className="rounded-2xl border border-slate-200 bg-white p-6 shadow">
            ...
            <ul className="mt-4 space-y-2 text-sm text-slate-700">
              <li>✅ Claim settlement guarantee or 100% refund</li>
              <li>✅ Full transparent pricing shared upfront</li>
              <li>✅ No extra fees charged in the middle of your case</li>
              <li>✅ Dedicated point of contact assigned to your case</li>
              <li>✅ Full process handled end-to-end by NadlaEPF</li>
            </ul>
        ...
        <div className="mx-auto w-[96vw] max-w-[1120px]">
          ...
          <div className="mt-8 overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
            <div className="grid grid-cols-[2fr_1fr_1fr] bg-slate-50 px-4 py-3 text-xs font-semibold text-slate-600">
              <div>Basis</div><div className="text-center text-blue-600">NadlaEPF</div><div className="text-center">Other PF Consultants</div>
            </div>
            {compareRows.map((row) => (
          ...
          <div className="mt-8 grid gap-3 md:grid-cols-5">
            {steps.map((step, idx) => (
              <article key={step} className="rounded-lg border border-slate-200 bg-white p-3 text-center">
                <div className="mx-auto mb-2 grid h-7 w-7 place-items-center rounded-full bg-blue-100 text-xs font-bold text-blue-700">{idx + 1}</div>
      ...
      <section className="bg-[#eef3f8] py-14">
        <div className="mx-auto grid w-[96vw] max-w-[1120px] gap-8 lg:grid-cols-2 lg:items-center">
          <div>
            <p className="text-xs font-semibold tracking-[0.16em] text-emerald-600">PAN-INDIA PF COVERAGE</p>
        ...
        <div className="mx-auto w-[96vw] max-w-[1120px]">
          ...
          <article className="mx-auto mt-8 max-w-[760px] rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <div className="mt-3 flex items-center justify-between text-xs text-slate-500">
              <span>Tanayjira</span>
              <span className="font-semibold text-emerald-600">Recovered Rs 3,59,000</span>
            </div>
          </article>
        </div>
      </section>
      ...
      <section className="bg-[#f6f8fb] py-14">
        <div className="mx-auto w-[96vw] max-w-[1120px] rounded-xl border border-slate-200 bg-gradient-to-r from-slate-50 to-blue-50 p-8 text-center">
          ...
          <button className="mt-5 rounded bg-blue-600 px-4 py-2 text-sm font-semibold text-white">Book Free Consultation</button>
          <p className="mt-2 text-xs text-emerald-600">Expert slots available today</p>
        </div>
      </section>
